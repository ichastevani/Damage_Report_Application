...
public class A5ManageReports extends javax.swing.JFrame {

    /**
     * Creates new form Home
     */
    public A5ManageReports() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        btnUpdate.setBackground(new java.awt.Color(75, 139, 245));
        ...
        cbxStatus.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "Progress", "Cancel", "Done", "Rejected" }));

        lblId.setText("-");

        jLabel2.setText("Laporan Dipilih :");
    ...
    private void btnUpdateActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUpdateActionPerformed
        ...
        String statusName = cbxStatus.getSelectedItem().toString();
        int status = Report.getStatusFromName(statusName);
        ...
        if(! rc.updateStatus(id, status)){
            JOptionPane.showMessageDialog(rootPane, 
                    "Gagal mengubah status laporan kerusakan.", 
                    "Error", 
                    JOptionPane.ERROR_MESSAGE);
            return;
        }
    ...
    private void updateTable(){
        ...
        ArrayList<Report> reports = rc.getAll();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(A5ManageReports.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
